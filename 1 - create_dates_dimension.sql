...
update dates set matchup = 2 where day_date between str_to_date('19/10/2021','%d/%m/%Y') and str_to_date('25/10/2021','%d/%m/%Y');
update dates set matchup = 3 where day_date between str_to_date('26/10/2021','%d/%m/%Y') and str_to_date('01/11/2021','%d/%m/%Y');
update dates set matchup = 4 where day_date between str_to_date('02/11/2021','%d/%m/%Y') and str_to_date('08/11/2021','%d/%m/%Y');
update dates set matchup = 5 where day_date between str_to_date('09/11/2021','%d/%m/%Y') and str_to_date('15/11/2021','%d/%m/%Y');
update dates set matchup = 6 where day_date between str_to_date('16/11/2021','%d/%m/%Y') and str_to_date('22/11/2021','%d/%m/%Y');
update dates set matchup = 7 where day_date between str_to_date('23/11/2021','%d/%m/%Y') and str_to_date('29/11/2021','%d/%m/%Y');
update dates set matchup = 8 where day_date between str_to_date('30/11/2021','%d/%m/%Y') and str_to_date('06/12/2021','%d/%m/%Y');
update dates set matchup = 9 where day_date between str_to_date('07/12/2021','%d/%m/%Y') and str_to_date('13/12/2021','%d/%m/%Y');
update dates set matchup = 10 where day_date between str_to_date('14/12/2021','%d/%m/%Y') and str_to_date('20/12/2021','%d/%m/%Y');
update dates set matchup = 11 where day_date between str_to_date('21/12/2021','%d/%m/%Y') and str_to_date('02/01/2022','%d/%m/%Y');
